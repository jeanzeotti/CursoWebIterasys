...
public class HomePageTests extends BaseTests {
	...
	public void testIncluirProdutoNoCarrinho_ProdutoIncluidoComSucesso() {
		...
		// --Pr�-condi��o
		// usu�rio logado
		if (!homePage.estaLogado("Marcello Bittencourt")) {
...
//		assertThat(modalProdutoPage.obterMensagemProdutoAdicionado().endsWith("Product successfully added to your shopping cart"), is(true));
		...
		System.out.println("descri��o produto:" + modalProdutoPage.obterDescricaoProduto());
		assertThat(modalProdutoPage.obterDescricaoProduto().toUpperCase(), is(nomeProduto_ProdutoPage.toUpperCase()));

		String precoProdutoString = modalProdutoPage.obterPrecoProduto();
		precoProdutoString = precoProdutoString.replace("$", "");
		Double precoProduto = Double.parseDouble(precoProdutoString);
		System.out.println("preco produto:" + modalProdutoPage.obterPrecoProduto());
		...
		System.out.println("subtotal:" + modalProdutoPage.obterSubtotal());
	...
	public void testIrParaCarrinho_InformacoesPersistidas() {
		...
		System.out.println("*** TELA CARRINHO***");
